...
%}
	...
	function proc_postgresql_event(msg: POSTGRESQL_PDU): bool
		%{
		// BifEvent::generate_postgresql_event(connection()->bro_analyzer(), connection()->bro_analyzer()->Conn(),
		// ${msg.firsthex},
	...
	function proc_postgresql_infos(msg: INFOS_PDU): bool
		%{
		// BifEvent::generate_postgresql_username(connection()->bro_analyzer(), connection()->bro_analyzer()->Conn(),
		//  new StringVal(${msg.user}.length(),(const char*)${msg.user}.begin())
		// );
